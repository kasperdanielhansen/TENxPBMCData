---
title: "Exploring the Peripheral Blood Mononuclear Cell (PBMC) scRNA-seq data from 10X Genomics"
author:
...
# Exploring the Peripheral Blood Mononuclear Cell (PBMC) scRNA-seq data from 10X Genomics

Package: `r Biocpkg("TENxPBMCData")` <br />
Author: Kasper Hansen, Stephanie Hicks, Davide Risso <br />
Modification date: 23 August, 2018 <br />
Compilation date: `r Sys.Date()`

The `r Biocpkg("TENxPBMCData")` package provides a _R_ /
_Bioconductor_ resource for representing and manipulating the 
nine different single-cell RNA-seq (scRNA-seq) data sets generated
by [10X Genomics][tenx]: 
...
tenx_pbmc4k <- TENxPBMCData(sample_name = c("pbmc4k"))
tenx_pbmc4k
```
